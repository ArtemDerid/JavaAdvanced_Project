...
<body style="background: #e6e6e6; color: black;">
	...
	<div id="main" style="margin-left: 200px">
		...
		<div class="container" style="margin-left: 100px">
			...
			<h2>
				<spring:message code='ee.enrolled' />
				<c:if test="${faculty.id == 1}">
					<spring:message code='home.economical' />
					<spring:message code='re.faculty' />
				</c:if>

				<c:if test="${faculty.id == 2}">
					<spring:message code='home.biological' />
					<spring:message code='re.faculty' />
				</c:if>

				<c:if test="${faculty.id == 3}">
					<spring:message code='re.faculty' />
					<spring:message code='home.languages' />
				</c:if>

				<c:if test="${faculty.id == 4}">
					<spring:message code='home.geographical' />
					<spring:message code='re.faculty' />
				</c:if>
			</h2>
			</div>
